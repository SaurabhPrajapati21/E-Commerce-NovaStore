...
const Menu = [
  ...
  { id: 4, name: "Kid's Wear", link: "#kids-wear" },
  { id: 5, name: "Men's Wear", link: "#mens-wear" },
...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full shadow-md bg-white text-black duration-200 z-40 navbar">
      {/* upper Navbar */}
      <div className="bg-primary/40 py-2">
        <div className="container flex justify-between items-center">
          ...
          <div className="flex justify-between items-center gap-4">
            ...
            {/* Profile button */}
            <button className="bg-transparent flex items-center gap-2 font-normal text-gray-700">
        ...
        <ul className="sm:flex hidden items-center gap-4">
          {Menu.map((data) => (
            <li key={data.id}>
              <a
                href={data.link}
                onClick={(e) => handleScrollTo(e, data.link)}
