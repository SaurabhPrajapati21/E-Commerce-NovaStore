  ...
  return (
    <div style={BannerImg} className="text-white mt-0 min-h-[320px]">
      <div className="container px-4 md:px-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 col-span-2 md:pl-10">
              ...
              <ul className="flex flex-col gap-3">
                {FooterLinks.map((link) => (
                  <li key={`important-${link.title}`}>
                    <span className="cursor-pointer hover:text-primary hover:translate-x-1 duration-300 text-gray-200">
                      {link.title}
                    </span>
                  </li>
                ))}
            ...
            <div className="py-8 px-4">
              ...
              <div className="mt-6">
                ...
                <div className="flex items-center gap-3 mt-3">
                  <FiMail />
                  <p>saurabhprajapati7378@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Footer Note */}
        <div className="border-t border-gray-600 py-4 text-center text-gray-300 text-sm">
