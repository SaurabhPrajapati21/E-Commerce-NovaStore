...
import BannerImg from "../../assets/women/winter.jpg";
      ...
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
          ...
          <div className="flex flex-col justify-center gap-6 sm:pt-0">
            ...
            >
              Wrap up in style this season with our exclusive Winter Sale!
              Discover cozy, fashionable layers at unbeatable prices – warmth
